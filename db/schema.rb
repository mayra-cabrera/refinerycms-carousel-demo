...
ActiveRecord::Schema.define(:version => 20140314011112) do

  create_table "refinery_carousel_parts", :force => true do |t|
    t.string   "title"
    t.text     "body"
    t.integer  "image_id"
    t.integer  "position"
  ...
  create_table "refinery_image", :force => true do |t|
  ...
  add_index "refinery_setting", ["name"], :name => "index_refinery_setting_on_name"
  ...
  add_index "slug", ["locale"], :name => "index_slug_on_locale"
